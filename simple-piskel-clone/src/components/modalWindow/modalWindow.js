export default class KeyModalWindow {
    ...
    _toggleModalWindow() {
        ...
        modalButton.addEventListener(this.events.click, this._toggleModalWindowEvent.bind(this));
    }
    ...
    _restoreDefaultShortcuts() {
        ...
        defaultButton.addEventListener(this.events.click, this.restoreDefaultKeys.bind(this));
    }
    ...
    _addKeyUpdating() {
        ...
        modalMain.addEventListener(this.events.click, this._keyUpdatingEvent.bind(this));
        document.addEventListener(this.events.keyup, this._keyUpdatingToNewKeyEvent.bind(this));
    ...
    _keyUpdatingEvent(event) {
        ...
        if (this.currentButton.tagName === "SPAN"
    ...
    _keyUpdatingToNewKeyEvent(event) {
        ...
        if (this.currentButton.classList.contains("key__active")) {
            ...
            if (keyCheck !== "Key") {
                keyError.querySelector(".key-error__description").textContent = "Please use only english letters (ex. A)";
            ...
            if (toKey === this.keys.penKey
                ...
                keyError.querySelector(".key-error__description").textContent = "Such a key already exists";
