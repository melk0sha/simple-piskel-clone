export default class Colors {
    ...
    _changeColorsEvent() {
        this.primaryColorElement.addEventListener(this.events.change,
            this._changePrimaryColorEvent.bind(this));
        this.secondaryColorElement.addEventListener(this.events.change,
            this._changeSecondaryColorEvent.bind(this));
        this.swapColorsElement.addEventListener(this.events.click, this.swapColors.bind(this));
    }
