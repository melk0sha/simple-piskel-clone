...
export default class PaintBucket extends Tool {
    ...
    initPaintBucket() {
        ...
        paintBucket.addEventListener(this.events.click, this._eventPaintBucket.bind(this));
    }
    ...
    _setPixel(imageData, x, y, color) {
        ...
        [pixel[offset + 0], pixel[offset + 1], pixel[offset + 2],
            pixel[offset + 3]] = [color[0], color[1], color[2], 255];
    }
