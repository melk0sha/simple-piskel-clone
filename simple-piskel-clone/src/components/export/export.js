...
export default class Export {
    ...
    _getExportInit() {
        ...
        exportButton.addEventListener(this.events.click, this._getExportInitEvent.bind(this));
        this.exportButtonGIF.addEventListener(this.events.click,
            this._getExportGIFEvent.bind(this));
        this.exportButtonUPNG.addEventListener(this.events.click,
