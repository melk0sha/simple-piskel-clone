export default class Shortcuts {
    ...
    restoreDefaultShortcuts() {
        ...
        document.querySelector(".color-select-key__key").textContent = this.keys.colorSelectKey;
        document.querySelector(".paint-bucket-key__key").textContent = this.keys.paintBucketKey;
        document.querySelector(".eraser-key__key").textContent = this.keys.eraserKey;
        document.querySelector(".paint-swap-key__key").textContent = this.keys.paintSwapKey;
        document.querySelector(".stroke-key__key").textContent = this.keys.strokeKey;
        document.querySelector(".swap-colors-key__key").textContent = this.keys.colorSwapKey;
        document.querySelector(".full-screen-key__key").textContent = this.keys.previewFullScreenKey;
        document.querySelector(".add-new-frame-key__key").textContent = this.keys.addNewFrame;
        document.querySelector(".delete-frame-key__key").textContent = this.keys.deleteFrame;
        document.querySelector(".copy-frame-key__key").textContent = this.keys.copyFrame;
        document.querySelector(".export-gif-key__key").textContent = this.keys.exportGIF;
        document.querySelector(".export-apng-key__key").textContent = this.keys.exportAPNG;
    }
